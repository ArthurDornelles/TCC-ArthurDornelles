module ConfigParameters
    ...
    export size_of_map, tax_rate, population_ratio, iterations
...
module RunningParameters

    export list_size_of_map, list_tax_rate, list_population_ratio, iterations

    const list_size_of_map = [500, 1000, 3000]
    const list_tax_rate = [0.01, 0.05, 0.10, 0.15,0.20]
